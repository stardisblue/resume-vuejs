<template>
  <div class="resume">
    ...
    <block-component v-if="resume" title="Curriculum Vitae">
      ...
      <interests v-bind="resume.interests"/>
    </block-component>
  </div>
</template>
...
import Interests from '@/components/resume/interests/Interests.vue'
...
@Component({
  components: { Work, Education, BlockComponent, Profile, Interests, 'option-button': Button },
